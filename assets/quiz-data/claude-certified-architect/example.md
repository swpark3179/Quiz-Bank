...
> **핵심 진단:** 팀원에게 영향을 주지 않으면서 개인 커스터마이즈를 적용하려면 `~/.claude/skills/` 폴더에 **다른 이름** 으로 개인 변형 파일을 생성해야 합니다.
...
3. **오답** - 팀원에게 영향을 주지 않으면서 개인 커스터마이즈를 적용하려면 `~/.claude/skills/` 폴더에 **다른 이름**으로 개인 변형 파일을 생성해야 합니다. 같은 이름으로 만드는 것은 권장 방식이 아닙니다.
